...
#############################################################
# [자료구조 비교]
# 1. Queue(큐) : FIFO(First In First Out) - 먼저 들어온 데이터가 먼저 나감
#    - 사용: collections.deque, queue.Queue
#    - 예시: 프린터 대기열, 웹서버 요청 처리
#
# 2. Deque(덱) : 양쪽 끝에서 삽입/삭제 가능한 큐
#    - 사용: collections.deque
#    - 예시: 슬라이딩 윈도우, 양방향 탐색
#
# 3. Priority Queue(우선순위 큐) : 우선순위가 높은 데이터가 먼저 나감
#    - 사용: heapq 모듈 (최소 힙 기반)
#    - 예시: 작업 스케줄링, 다익스트라 알고리즘
