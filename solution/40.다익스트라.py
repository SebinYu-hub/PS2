...
import heapq
from collections import defaultdict  # defaultdict 추가 - KeyError 방지 및 초기화 간소화
...
def solution(graph, start):
    ...
    # 우선순위 큐 사용 - 최소 거리 노드 선택 O(logV)
    queue = []
    heapq.heappush(queue, [0, start])  # 시작점 추가
    ...
    while queue:
        ...
        for adjacent_node, weight in graph[current_node].items():
            ...
            if distance < distances[adjacent_node]:
                ...
                # list concatenation으로 새로운 경로 생성
