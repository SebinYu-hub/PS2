...
- result: int
  ...
  - 제약: result >= 0
  - 설명:
    1. 각 플레이어는 자신의 턴에서 상하좌우로 이동 가능
    2. 이동한 발판은 사라짐
    3. 더 이상 이동할 수 없는 플레이어가 패배
    4. 두 플레이어가 최적의 전략으로 플레이할 때의 총 턴 수
    5. A가 먼저 시작하고 B가 다음 턴을 진행
    6. 게임이 시작하자마자 끝나는 경우 0 반환
"""
"""
[문제 특징] : [알고리즘 선택 이유]
...
백트래킹: **모든 가능한 해를 찾고 돌아오기 가능**, 불필요한 탐색은 피함
메모이제이션: 동일한 계산의 반복을 피함 **못돌아와서 그럼**
"""
"""
[자료구조]
1. Cache Dictionary
